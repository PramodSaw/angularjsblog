...
module.exports = (router) => {
    ...
    var options = {
        auth: {
            //api_user: 'pramod_saw',
            //api_key: 'Ajayaarya@1',
            api_key: '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'
        }
    }
        ...
        if (req.body.username == null || req.body.username == '' || req.body.password == null || req.body.password == '' || req.body.email == null || req.body.email == '' || req.body.name == null || req.body.name == '' || req.body.phone == null || req.body.phone == '') {
            ...
            user.save(function (err) {
                if (err) {
                    ...
                    var email = {
                        from: 'MEAN Stack Staff, pramodhbagh@gmail.com',
                        to: user.email,
            ...
            if (err) {
                ...
                client.sendMail(email, function (err, info) {
                    if (err) {
                        ...
                        console.log(info); // Log success message to console if sent
                        console.log(user.email); // Display e-mail that it was to 
                    }
                });
                res.json({ success: false, message: 'Something went wrong. This error has been logged and will be addressed by our staff. We apologize for this inconvenience!' });
            } else {
